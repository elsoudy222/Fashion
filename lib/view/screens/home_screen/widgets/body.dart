...
import 'package:fashion/view/screens/product_details/product_details_screen.dart';
      ...
      children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: model!.data!.products!.map((e) =>
                InkWell(
                  onTap: (){
                  //  LayoutCubit.get(context).getProductDetails(products.id!);
                    navigateTo(
                      context,
